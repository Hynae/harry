package com.wildcodeschool.harry.utils;
...
import com.wildcodeschool.harry.repositories.UserDao;
...
public class Outputter implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = new User("Dumbledore", "director", 110);
        LOG.info("******************");
        ...
        User user2 = new User("Severus", "potion master", 45);
        LOG.info("******************");
